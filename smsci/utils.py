...
def get_dset_pathSDD(dset_name, dset_type):
    # Assuming the file is in the datasets directory within your project
    _dir = os.path.dirname(__file__)  # Get the current file's directory
